...
basedir = '/home/jgomes/OpenPCDet/data/kitti/training/'
#basedir = '/home/jgomes/OpenPCDet/data/kitti/testing/' 
  ...
  for key in labeld.keys ():
    ...
    for o in range( labeld[key].shape[0]):
      ...
      if key != 'DontCare' :
        ...
        ratio, h = computeBox3D(labeld[key][o], P2_rect)
        ratio, h = computeBox3D(labeld[key][o], P2_rect, height/ratio)
        hs.append(h)
...
def main ():
  ...
  for subdir, dirs, files in os.walk(basedir+label+"/"):
    for file in files:
      frame = file[:-4]
  ...
  # for frame in ["000000", "000001", "000150", "000205", "000775", "000808", "000871", "001584", "001599", "001955", "002738", "003473", "003592", "007328"]:
      ...
      hs = labelToBoundingBox(label_data, calib_data)
      ...
      with open(basedir+label+"/"+frame+".txt", "w") as f:
        for i in label_text:
